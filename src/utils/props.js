...
export const homePage1 = home + "/images/homePage1.jpg";
export const homePage2 = home + "/images/homePage2.jpg";
...
export const connectionUrlString = 'https://api.trzebachleba.pl/';