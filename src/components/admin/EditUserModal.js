        ...
        <div className="fixed inset-0 z-50">
            <AnimatedModal onClose={onClose}>
                <form
                    ...
                    <h1 className="mb-12 text-4xl text-center w-auto font-semibold leading-loose text-[#fda329] ">Edytuj
                        użytkownika</h1>
                    <div className="grid gap-6 mb-6 md:grid-cols-2">
                        <FormInput register={register} id="firstName" label="Imię" type="text" maxLength="40"
                ...
                +48
                        ...
                        <FormInput register={register} id="email" label="Email" type="email" maxLength="50"
                                   value={userData.email} onChange={(e) => handleInputChange('email', e.target.value)}/>
                    </div>
