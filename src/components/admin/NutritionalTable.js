            ...
            <div className="relative overflow-x-auto">
                <table className="w-full text-sm text-left rtl:text-right text-gray-500">
                    ...
                    <tr className="bg-white border-b">
                        <th scope="row" className="px-1 sm:px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                            Wartość energetyczna (KJ/KCAL)
                        </th>
                        <td className="px-1 sm:px-6  py-1">
                            <div className="flex flex-row gap-1 sm:grid sm:grid-cols-3 items-center w-fit sm:w-auto">
                                <input {...register("kj")} value={productsData.kj}
                                       ...
                                       className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[#fda329] focus:border-[#fda329] block w-14 sm:w-20 p-2"
                    ...
                    <tr className="bg-white border-b">
                        ...
                        <td className="px-1 sm:px-6  py-1">
                            <input {...register("fat")} value={productsData.fat}
                                   ...
                                   className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[#fda329] focus:border-[#fda329] block w-24 sm:w-auto p-2"
