...
export const AdminNavMenu = () => {
    ...
    return (<>
                ...
                <div className="flex justify-between">
                    <div className="flex items-center justify-start">
                        ...
                        <div className="flex ml-2 md:mr-24">
                            ...
                            <span
                                className="self-center text-3xl text-yellow-orange-400 font-[lucida-console] font-bold">Admin Panel</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <aside id="logo-sidebar"
               className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-gray-300 border-r border-gray-200 sm:translate-x-0"
               aria-label="Sidebar">
