...
const OrderConfirmModal = ({ visible, message, onConfirm, onCancel, isLoading }) => {
    if (!visible) {
        return null;
    }
                ...
                <div className="backgroundElements relative rounded-lg shadow mt-20 bg-white" >
                    ...
                    <div className="p-4 md:p-5 text-center">
                        ...
                        {!isLoading ? (
                            ...
                            >
                                <div role="status">
                                    <svg aria-hidden="true" className="inline w-4 h-4 text-gray-200 animate-spin dark:text-gray-600 fill-green-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
