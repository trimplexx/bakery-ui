                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-7 gap-5 mb-4">
                        ...
                        <div
                            ...
                            <div className="flex px-2 mt-6">
                                        <span className="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-2 text-sm font-medium text-center text-gray-900 bg-gray-200 border border-gray-300 rounded">
